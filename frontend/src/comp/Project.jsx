            ...
            <div className="m-5 i justify-center">
                    ...
                    <div className='flex flex-wrap justify-around'>
                        <div className="mt-8 w-[30rem]">
                            ...
                            <a href="https://devpost.com/software/cbc-p2gweu" className="mt-4 block w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Devpost Hackathon Submission</a>
                        </div>
                        <div className="mt-8 w-[30rem]">
                            ...
                            <a href="https://github.com/Ankit-Rattan/ThoughtBox---OpenChat" className="mt-4 block w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Github Repository</a>
                        </div>
                        <div className="mt-8 w-[30rem]">
                        ...
                        <div className="mt-8 w-[30rem]">
                            ...
                            <a href="https://upvisionnitdelhi.netlify.app/" className="mt-4 block w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Website Link</a>
                        </div>
                    </div>
            </div>
        </>
