    ...
    <div className="mt-16">
      <div className="container mx-auto px-4 py-8 ">
        ...
        <div className='flex flex-wrap justify-around items-center'>
          <a href='https://leetcode.com/rattanankit2004/' className='text-orange-300 text-2xl font-mono mx-4 transition duration-500 ease-in-out transform hover:scale-110  hover:text-orange-400 '>LeetCode<br/><p className='text-xl text-orange-200'>150+ Ques</p> </a>
